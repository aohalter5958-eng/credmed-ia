...
<div class="hero">
    <h1>🏥 CredMed IA</h1>
    <h3>Plataforma SaaS de análise inteligente de credenciamentos médicos, licitações públicas e oportunidades na saúde.</h3>
</div>
...
with col3:
    st.markdown("""
    <div class="metric-card">
        <div class="metric-title">Status da IA</div>
...
with col4:
    st.markdown("""
    <div class="metric-card">
        <div class="metric-title">Módulo</div>
...
<div class="card">
    <h2>📄 Nova análise</h2>
    <p>Envie um edital de credenciamento ou licitação em PDF. A IA analisará documentos, prazos, valores, riscos e próximos passos.</p>
</div>
""", unsafe_allow_html=True)
